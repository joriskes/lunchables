...
<a id="presentations-list-trigger" bind:this={openTrigger} class="absolute bottom-0 cursor-pointer m-4">Show other presentations</a>

<dialog id="presentations-list" bind:this={demoDrawer} class="flex flex-col items-center justify-start">
